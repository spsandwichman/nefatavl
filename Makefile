...
CFLAGS = -MD -Wall -Wno-unused-variable -Wno-format -Wincompatible-pointer-types -Wno-discarded-qualifiers -lm -Wno-deprecated-declarations -Wreturn-type
OPT = -Ofast -flto
# OPT = -O0
